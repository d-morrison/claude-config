...
**Requirements:** git, [Claude Code CLI](https://claude.ai/code).
...
`bootstrap.sh` symlinks each top-level directory into `~/.claude/`. Run it again any time you add a new top-level dir to the repo.
