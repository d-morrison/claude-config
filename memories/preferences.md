...
- When a memory, skill, or doc entry points at a location in *another* file, don't cite
  ...
  as the inline-R-expressions rule above: don't bake a volatile value into prose. (ai-config#135 review: a
  `debugging.md` note cited `scout-peers/SKILL.md` lines 156/183, which #132's `bfc17ee`
  had already removed.)
