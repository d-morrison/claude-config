---
name: "sus"
description: "Codex wrapper for the ai-config Claude skill `sus`. Alias for `sup` (send-upstream). File an issue or open a PR on an upstream repo (a fork's parent, a dependency, or any external project). Use when asked to 'sus', 'send upstream', 'file upstream issue', 'upstream PR', 'contribute this fix back', or 'report this bug upstream'. Use when Codex is asked to use `sus`, `/sus`, or the corresponding ai-config/Claude skill workflow."
---
